...
import com.openclassrooms.savemytrip.database.dao.classeDatabase.SaveMyTripDatabase;
import com.openclassrooms.savemytrip.models.Item;
import com.openclassrooms.savemytrip.models.User;
import com.openclassrooms.savemytrip.utilsTest.LiveDataTestUtils;
...
public class ItemDaoTest {
    ...
    public void insertAndGetUser() throws InterruptedException {
        ...
        // TEST
        User user = LiveDataTestUtils.getValue(this.database.userDao().getUser(USER_ID));
    ...
    public void getItemsWhenNoItemInserted() throws InterruptedException {
        // TEST
        List<Item> items = LiveDataTestUtils.getValue(this.database.itemDao().getItems(USER_ID));
    ...
    public void insertAndUpdateItem() throws InterruptedException {
        ...
        this.database.userDao().createUser(USER_DEMO);
        this.database.itemDao().insertItem(NEW_ITEM_PLACE_TO_VISIT);
        Item itemAdded = LiveDataTestUtils.getValue(this.database.itemDao().getItems(USER_ID)).get(0);
